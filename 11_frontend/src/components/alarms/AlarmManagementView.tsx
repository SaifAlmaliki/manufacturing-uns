...
export const AlarmManagementView: React.FC = () => {
  ...
  return (
    <div id="alarm-management-view" className="flex-1 flex flex-col h-full bg-[#050505] text-[#F8FAFC] font-sans text-xs overflow-hidden">
      {/* Top Banner: Metric Statistics & Role Filter */}
      <div className="p-3 md:p-4 bg-[#111114] border-b border-[#1E293B] flex flex-wrap items-center justify-between gap-3 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="font-display font-bold text-sm sm:text-base text-[#F8FAFC]">
                Alarm &amp; Alert Management
              </h1>
              <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-[#1E293B] text-[#FFC107] border border-[#334155]">
                ISA-18.2 Compliant
              </span>
            </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-xs font-mono transition-colors cursor-pointer ${
              isMuted
                ...
                : 'bg-[#0B0B0C] border-[#1E293B] hover:border-[#FFC107] text-[#94A3B8] hover:text-[#FFC107]'
            }`}
            title={isMuted ? 'Unmute Audio Chime' : 'Mute Alarm Audio Chimes'}
          >
            {isMuted ? <VolumeX className="w-4 h-4 text-rose-400" /> : <Volume2 className="w-4 h-4 text-[#FFC107]" />}
          ...
          {myUnacknowledgedCount > 0 && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-300 border border-emerald-500/40 rounded-lg text-xs font-mono font-semibold transition-colors cursor-pointer"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#FFC107] hover:bg-[#FFB300] text-[#0B0B0C] font-bold rounded-lg text-xs font-mono transition-colors cursor-pointer shadow-sm"
          >
      ...
      {/* Metric Stat Strip */}
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 p-3 bg-[#0B0B0C] border-b border-[#1E293B] shrink-0 text-xs">
        {/* Critical Alarms */}
        <div className="bg-[#111114] border border-[#1E293B] rounded-lg p-2.5 flex items-center justify-between">
          <div>
            <div className="text-[10px] text-[#64748B] uppercase font-mono tracking-wider">Critical Alarms</div>
            <div className={`text-base sm:text-lg font-mono font-bold ${criticalAlarmsCount > 0 ? 'text-rose-400' : 'text-[#F8FAFC]'}`}>
              {criticalAlarmsCount}
            </div>
          </div>
        ...
        <div className="bg-[#111114] border border-[#1E293B] rounded-lg p-2.5 flex items-center justify-between">
          <div>
            ...
            <div className={`text-base sm:text-lg font-mono font-bold ${myUnacknowledgedCount > 0 ? 'text-[#FFC107]' : 'text-[#F8FAFC]'}`}>
              {myUnacknowledgedCount}
            </div>
          </div>
          <div className="w-8 h-8 rounded-lg bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-[#FFC107]">
        ...
        <div className="bg-[#111114] border border-[#1E293B] rounded-lg p-2.5 flex items-center justify-between">
          <div>
            ...
            <div className="text-base sm:text-lg font-mono font-bold text-[#F8FAFC]">
              {activeAlarms.filter((a) => a.status !== 'RESOLVED').length}
            </div>
          </div>
          <div className="w-8 h-8 rounded-lg bg-[#0B0B0C] border border-[#1E293B] flex items-center justify-center text-[#94A3B8]">
      ...
      <div className="flex-1 overflow-y-auto p-3 sm:p-4 scrollbar-thin scrollbar-thumb-[#1E293B]">
        {activeSubTab === 'active' && (
          <div className="space-y-4">
            ...
            <div className="bg-[#111114] border border-[#1E293B] rounded-lg p-3 flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-1 bg-[#0B0B0C] p-1 rounded-lg border border-[#1E293B]">
                <button
              ...
              <div className="flex items-center gap-2 flex-1 sm:flex-initial min-w-[280px]">
                ...
                <button
                  ...
                  className="px-2.5 py-1.5 rounded bg-[#0B0B0C] border border-[#1E293B] text-[#94A3B8] hover:text-[#F8FAFC] text-xs font-mono transition-colors cursor-pointer shrink-0"
            ...
            {displayedAlarms.length === 0 ? (
              <div className="bg-[#111114] border border-[#1E293B] rounded-xl p-12 text-center text-[#64748B] space-y-3">
                <CheckCircle2 className="w-12 h-12 text-emerald-400 mx-auto opacity-70" />
                <h3 className="font-bold text-[#F8FAFC] text-sm">No Active Incidents</h3>
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="px-3 py-1.5 bg-[#1E293B] hover:bg-[#334155] text-[#FFC107] rounded-lg text-xs font-mono font-bold transition-colors cursor-pointer"
                  >
                    Simulate Test Alarm
                  </button>
                </div>
                ...
                {displayedAlarms.map((alarm) => {
                  ...
                  return (
                      ...
                      className={`p-3.5 rounded-xl border transition-all ${
                        alarm.status === 'ACTIVE_UNACK'
                          ? alarm.severity === 'CRITICAL'
                            ...
                            : 'bg-[#111114] border-amber-500/40'
                          : alarm.status === 'RESOLVED'
                          ? 'bg-[#0B0B0C] border-[#1E293B] opacity-75'
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {alarm.status === 'ACTIVE_UNACK' && (
                            <button
                              ...
                              className="px-2.5 py-1 bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-300 border border-emerald-500/40 rounded text-xs font-mono font-bold transition-colors cursor-pointer flex items-center gap-1"
                            >
                          ...
                          {alarm.status !== 'RESOLVED' && (
                            <button
                              ...
                              className="px-2.5 py-1 bg-[#1E293B] hover:bg-[#334155] text-[#94A3B8] hover:text-[#F8FAFC] border border-[#334155] rounded text-xs font-mono transition-colors cursor-pointer"
                            >
                              Resolve
                            </button>
                          )}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-12 gap-2 text-xs py-2 bg-[#0B0B0C] rounded-lg p-2.5 border border-[#1E293B] my-2">
                        <div className="md:col-span-8 space-y-1">
                          <div className="flex items-center gap-2 text-[11px] font-mono text-[#FFC107]">
                            <AlertTriangle className="w-3.5 h-3.5 shrink-0" />
                            <span className="font-semibold">{alarm.conditionDescription}</span>
                          </div>
                          <div className="text-[10px] text-[#94A3B8] font-mono truncate flex items-center gap-1">
                            <span className="text-[#64748B]">TOPIC:</span>
                            <span className="text-[#F8FAFC]">{alarm.topic}</span>
                          </div>
                        </div>
                        ...
                        <div className="md:col-span-4 flex items-center justify-between md:justify-end gap-3 text-right">
                          ...
                          <button
                            ...
                            className="p-1.5 rounded bg-[#111114] border border-[#1E293B] hover:border-[#FFC107] text-[#94A3B8] hover:text-[#FFC107] transition-colors cursor-pointer"
                      ...
                      {alarm.notes && (
                        <div className="mt-1.5 pt-1.5 border-t border-[#1E293B] text-[11px] text-[#94A3B8] italic">
                          "{alarm.notes}"
                        </div>
                      )}
                    </div>
        ...
        {activeSubTab === 'rules' && (
          <div className="space-y-4">
            ...
            <div className="bg-[#111114] border border-[#1E293B] rounded-lg p-3 flex items-center justify-between">
              <div>
                <h2 className="font-display font-bold text-sm text-[#F8FAFC]">Configured Alert Rules</h2>
              ...
              <button
                onClick={handleOpenCreateRule}
                className="px-3 py-1.5 bg-[#FFC107] hover:bg-[#FFB300] text-[#0B0B0C] font-bold rounded-lg text-xs font-mono transition-colors cursor-pointer flex items-center gap-1.5"
              >
                <Plus className="w-4 h-4" />
                <span>Add Rule</span>
              </button>
            ...
            {/* Rules Table */}
            <div className="bg-[#111114] border border-[#1E293B] rounded-xl overflow-hidden">
                    ...
                    {rules.map((rule) => (
                      <tr key={rule.id} className="hover:bg-[#1E293B]/20 transition-colors">
                        ...
                        <td className="py-3 px-3">
                          <button
                            ...
                            className={`w-9 h-5 rounded-full p-0.5 transition-colors cursor-pointer flex items-center ${
                              rule.enabled ? 'bg-emerald-500 justify-end' : 'bg-[#1E293B] justify-start'
                            }`}
                        ...
                        <td className="py-3 px-3 min-w-[220px]">
                          ...
                          <div className="text-[10px] text-[#94A3B8] truncate max-w-xs">{rule.topic}</div>
                        </td>

                        {/* Condition & Threshold */}
                        <td className="py-3 px-3">
                          <span className="px-2 py-0.5 rounded bg-[#0B0B0C] border border-[#1E293B] text-[#FFC107] font-semibold">
                        ...
                        <td className="py-3 px-3">
                          <div className="flex flex-wrap gap-1">
                            {rule.targetRoles.map((role) => (
                              <span
                                key={role}
                                className="px-1.5 py-0.2 rounded bg-[#0B0B0C] border border-[#1E293B] text-[9px] text-[#94A3B8]"
                              >
                                {role}
                              </span>
                            ))}
                        ...
                        {/* Triggers Count */}
                        <td className="py-3 px-3 text-center text-[#F8FAFC] font-bold">
                          {rule.triggerCount}
                        </td>
                        ...
                        <td className="py-3 px-3 text-right">
                          <div className="flex items-center justify-end gap-1.5">
                            <button
                              ...
                              className="px-2 py-1 bg-[#1E293B] hover:bg-[#334155] text-[#FFC107] rounded text-[10px] transition-colors cursor-pointer"
                            ...
                            <button
                              ...
                              className="px-2 py-1 bg-[#1E293B] hover:bg-[#334155] text-[#94A3B8] hover:text-[#F8FAFC] rounded text-[10px] transition-colors cursor-pointer"
                            >
                              Edit
                            </button>
                            <button
                              onClick={() => deleteRule(rule.id)}
                              className="px-2 py-1 bg-[#1E293B] hover:bg-rose-950/40 text-[#64748B] hover:text-rose-400 rounded text-[10px] transition-colors cursor-pointer"
                            >
                              Delete
                            </button>
                          </div>
      ...
      {acknowledgingAlarm && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#111114] border border-[#1E293B] rounded-xl max-w-md w-full p-4 space-y-3 font-sans shadow-2xl">
            <div className="flex items-center justify-between border-b border-[#1E293B] pb-2.5">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5 text-emerald-400" />
                <h3 className="font-bold text-sm text-[#F8FAFC]">Acknowledge Incident</h3>
              </div>
              <button
            ...
            <div className="space-y-2 text-xs">
              <div className="p-2 rounded bg-[#0B0B0C] border border-[#1E293B] space-y-1">
                <div className="font-bold text-[#FFC107]">{acknowledgingAlarm.ruleName}</div>
                <div className="text-[11px] text-[#94A3B8] font-mono">{acknowledgingAlarm.conditionDescription}</div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-[#0B0B0C] border border-[#1E293B] rounded-lg p-2 text-xs text-[#F8FAFC] focus:outline-none focus:border-[#FFC107] font-sans"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-2 pt-2 border-t border-[#1E293B]">
              <button
                onClick={() => setAcknowledgingAlarm(null)}
                className="px-3 py-1.5 rounded-lg border border-[#1E293B] text-[#94A3B8] hover:text-[#F8FAFC] text-xs font-mono cursor-pointer"
              >
                Cancel
              </button>
              <button
          ...
          <div className="bg-[#111114] border border-[#1E293B] rounded-xl max-w-md w-full p-4 space-y-3 font-sans shadow-2xl">
            <div className="flex items-center justify-between border-b border-[#1E293B] pb-2.5">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-sm text-[#F8FAFC]">Resolve Incident</h3>
              </div>
              <button
            ...
            <div className="space-y-2 text-xs">
              <div className="p-2 rounded bg-[#0B0B0C] border border-[#1E293B]">
                <div className="font-bold text-[#F8FAFC]">{resolvingAlarm.ruleName}</div>
            ...
            <div className="flex items-center justify-end gap-2 pt-2 border-t border-[#1E293B]">
              ...
              <button
                ...
                className="px-4 py-1.5 rounded-lg bg-[#FFC107] hover:bg-[#FFB300] text-[#0B0B0C] font-bold text-xs font-mono cursor-pointer"
              >
                Mark Resolved
              </button>
            </div>
