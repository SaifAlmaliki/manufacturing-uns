...
class Mutation:
    """All write access to schema `console`."""
    ...
    async def save_alert_rule(self, rule: AlertRuleInput) -> AlertRuleType:
    ...
    async def save_alert_rules(self, rules: list[AlertRuleInput]) -> list[AlertRuleType]:
    ...
    async def delete_alert_rule(self, id: str) -> bool:  # noqa: A002
    ...
    async def set_alert_rule_enabled(self, id: str, enabled: bool) -> AlertRuleType | None:  # noqa: A002
    ...
    async def record_alert_rule_evaluation(self, id: str, triggered: bool) -> AlertRuleType | None:  # noqa: A002
