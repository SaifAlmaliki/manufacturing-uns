...
def compile(
    ...
    *,
    ...
    controller_type = require_str(connection.get("controller_type"), "connection.controller_type")
    config: dict[str, Any] = {
        "host": host,
        "port": port,
    ...
    return CompiledAdapter(
        ...
        adapter_body={"id": adapter.adapter_id, "type": "s7", "config": config},
        tags=tag_items,
