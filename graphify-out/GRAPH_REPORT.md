...
## Corpus Check
- 504 files · ~286,822 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6224 nodes · 15964 edges · 249 communities (222 shown, 27 thin omitted)
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 4360 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fcf32dac`
...
## Communities (249 total, 27 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (89): BrowseDataDrawerProps, asInt(), AuthHooks, BinaryOperator, defaultAuthHooks, auth, PLANT, mapAccessGroup() (+81 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (50): adminBase(), authHeaders(), DirectoryResult, fetchRealmMembers(), KeycloakUser, RealmMember, rolesOf(), KEYCLOAK_USERS (+42 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (87): AddressSpaceTreeProps, BrowseDataDrawer(), mergeRows(), RowState, uniqueDiscovered(), ConnectivityView(), DIALOG_COPY, dialogCopyFor() (+79 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (115): ClassifiedStop, datetime, Interval, ManualReason, MasterDataLoader, MetricSource, ProductSegment, ResultPublisher (+107 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (92): Any, Database, datetime, OeeConfig, OeeMetrics, PassSummary, ResultPublisher, Database (+84 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (76): _FakeDatabase, _FakeSession, _loader_blob(), *******************************************************************************, `save_tag` must write `data_type` so a one-mutation save can set it, no second p, A node absent from a later discovery stays subscribed until `unsubscribe_tag`., Discovery may correct a browse path or display name without touching the topic., Fakes just enough of AsyncSession for `subscribed_topics`: one `execute().all()` (+68 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (38): compile_pg(), Tests for the conf/oee/*.yaml importer.  `plan_from_oee_config` is a pure func, `uns_model_setup` seeds, then imports OEE. A unit that names a missing Asset, test_a_full_config_records_every_oee_conf_file_as_present(), test_a_producing_state_must_not_also_have_a_reason_rule(), test_a_shifts_only_config_records_only_the_shifts_file_as_present(), test_a_shifts_only_plan_does_not_reconcile_units_or_products(), test_a_slot_is_expanded_once_per_day_it_names() (+30 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (70): datetime, ShiftWindow, UnitMasterData, ShiftSchedule, `FOR UPDATE SKIP LOCKED` in a `RETURNING` update. Two claimers must partition th, test_claim_requests_hands_each_row_to_one_claimer(), days(), FakeConnection (+62 more)
...
Cohesion: 0.06
Nodes (49): datetime, FakeConnection, FakeDatabase, FakeResult, Tests for the historian read path.  The SQL is exercised for real in the end-t, Stands in for `uns_model.engine.Database`; only `begin()` is used by MetricSourc, test_a_binding_splits_into_topic_and_metric_name(), test_a_binding_with_no_slash_is_rejected() (+41 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (48): ALERT_TAB_PATHS, AlertTabId, AlarmOutletContext, AlarmPanel(), getSeverityBadge(), getStatusBadge(), PREDEFINED_ROLES, GRAFANA_DASHBOARDS (+40 more)

### Community 12 - "Community 12"
Cohesion: 0.09
Nodes (50): Any, ConversationStore, FastAPI, Identity, JwksCache, ModelTurn, AbstractAsyncContextManager, BaseModel (+42 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (54): AlarmActiveTab(), AlarmAuditLog(), AlarmManagementLayout(), AlarmRulesTab(), RoleAlertMatrix(), LoginView(), login, grafanaRangeFromPreset() (+46 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (39): AssetLevelIcon(), addDescription(), DESCRIPTIONS, EDITOR_LEVELS, levelDef, NodeLevel, ORDER, remainingChildren() (+31 more)
...
Cohesion: 0.08
Nodes (36): alarmMatchesTag(), conditionKpis, isFaultTag(), assetLeafLabel(), collectLoadedDescendants(), filterTagsBySearch(), pathSegments(), tagInScope() (+28 more)
...
Cohesion: 0.07
Nodes (58): DowntimeEventRow, ShiftResultRow, DowntimeEventRow, DowntimeEvent, Enum, ShiftResult, datetime, ShiftResult (+50 more)

### Community 22 - "Community 22"
Cohesion: 0.10
Nodes (42): Any, Database, datetime, Database, Database, Interval, ShiftSchedule, MetricRef (+34 more)
...
Cohesion: 0.14
Nodes (26): ConnectivityServer, ConnectivityTag, ConnectivityTag, _E, Enum, ConnectivityAuthMode, ConnectivityProtocol, ConnectivitySecurityMode (+18 more)
...
Cohesion: 0.10
Nodes (33): Tests for the ISA-95 hierarchy tree and prefix rename validation., test_a_slash_in_a_segment_is_rejected(), test_cell_mapping_coerces_authored_machines(), test_join_and_split_round_trip(), test_rename_must_exist_on_the_previous_tree(), test_string_cells_coerce_to_cells_with_no_machines(), all_prefixes(), _area_prefix() (+25 more)
...
Cohesion: 0.09
Nodes (44): _clean(), database(), *******************************************************************************, Remove everything these tests could have written, in FK-safe order., _assign_planned_reason(), _counter(), _insert_samples(), pipeline() (+36 more)
...
Cohesion: 0.06
Nodes (34): FastAPI, AuthenticatedGraphQLRouter, A router whose subscriptions need an identity too.      `on_ws_connect` runs a, ConnectivityMutation, GraphQLRouter, HierarchyMutation, HierarchyQuery, OpcUaSubscription (+26 more)
...
Cohesion: 0.08
Nodes (17): Any, Database, datetime, *******************************************************************************, test_execute_prepared(), test_persist_mqtt_msg(), test_persist_mqtt_msg_dual_writes_metrics(), _asyncpg_params_to_sqlalchemy() (+9 more)
...
Cohesion: 0.14
Nodes (18): bucketMessageActivity(), formatAge(), formatEventValue(), formatTopicShort(), freshnessPct(), isDashboardNoiseTopic(), isProcessMessage(), lastMessageAgeMs() (+10 more)
...
Cohesion: 0.07
Nodes (50): Interval, StopInterval, datetime, ReasonResolver, Tests for resolving a machine state into a downtime reason code.  Three behavi, resolver(), stop(), t() (+42 more)
...
Cohesion: 0.23
Nodes (6): AsyncSession, AccessGroupRecord, AccessGroupRepository, One group per Area, named for `area.segment`, rooted at that Area.          Up, Add the pinned demo subjects. Idempotent; never adds admin., Named Access Groups, their Asset roots, and Keycloak member subjects.
...
Cohesion: 0.31
Nodes (19): HierarchyTree, _filter_hierarchy(), Drop sites/areas/lines/cells whose joined path is outside the caller's scope., test_get_hierarchy_hides_rawwater_from_filtration_operator(), test_load_plant_tree_reads_settings_hierarchy(), test_all_prefixes_include_machines(), test_duplicate_sibling_cells_are_rejected(), test_duplicate_sibling_machines_are_rejected() (+11 more)
...
Cohesion: 0.05
Nodes (44): Any, AsyncSession, ConnectivityServer, ConnectivityTag, Database, datetime, EdgeAdapterInput, SignalLabel (+36 more)
...
Cohesion: 0.12
Nodes (11): Exception, Any, The realm's signing keys, fetched once and kept.  Fetching per request would p, No key with that `kid`, and a refetch did not produce one., UnknownSigningKeyError, JWKS cache must keep signing keys even when Keycloak also publishes encryption k, test_encryption_keys_in_the_jwks_document_are_skipped(), The JWKS document does not publish the kid the token names. (+3 more)

### Community 111 - "Community 111"
Cohesion: 0.05
Nodes (55): AlertRule, AlertRule, AlertRule, Enum, Asset, Database, Database, AccessGroup (+47 more)

### Community 112 - "Community 112"
Cohesion: 0.23
Nodes (20): AccessScope, SimpleNamespace, AlertRuleMutation, _bind_topic(), _filt_scope(), _info(), Plant writes refuse Assets and topics outside the caller's Access Groups., Load first: an out-of-scope stop must not be attributed, then hidden. (+12 more)

### Community 113 - "Community 113"
Cohesion: 0.15
Nodes (11): _identity(), Admin must not open the Asset Model — unit tests and All Modules CI have no hist, Browse-path MQTT topics are authorized via the Connectivity catalog binding., test_allowed_topic_rejects_unbound_browse_path(), test_allowed_topic_skips_binding_when_unrestricted(), test_allowed_topic_uses_connectivity_asset_when_topic_unmodelled(), test_covers_path_uses_the_model_rule(), test_scope_for_admin_is_unrestricted_without_loading_roots() (+3 more)
...
Cohesion: 0.06
Nodes (41): SSLContext, UnsMQTTClient, AbstractEventLoop, Future, IntEnum, clean_up_database(), _close_shared_database(), create_publisher() (+33 more)
...
Cohesion: 0.04
Nodes (69): Any, AssetModelRepository, Path, AsyncConnection, AsyncEngine, AsyncSession, SSLContext, Database (+61 more)
...
Cohesion: 0.22
Nodes (8): test_uns_mqtt_historian_main_negative_pool_closure(), test_uns_mqtt_historian_main_positive_pool_closure(), Prometheus instrumentation for the historian mapper., Expose /metrics for Prometheus scraping., start_metrics_server(), main(), *******************************************************************************, Main function invoked from command line
...
Cohesion: 0.10
Nodes (39): Any, datetime, Path, time, datetime, OeeMasterDataRepository, ShiftPatternSpec, Stands in for `ResultPublisher`. Real MQTT is Task 23's business. (+31 more)
...
Cohesion: 0.18
Nodes (12): ShiftResultRow, *******************************************************************************, Spec section 10 writes the signature down. Asserted by introspection rather than, A shift with no Loading Time must not arrive at the dashboard as 0%., Not an error: a line whose first shift has not closed yet is normal., _result_row(), test_a_null_factor_is_null_in_the_response(), test_an_asset_with_no_results_is_an_empty_list() (+4 more)
...
Cohesion: 0.09
Nodes (29): AccessScope, AlertRuleRepository, AlertRuleType, Info, AssetModelRepository, Info, AlertRuleSummary, AssetModelSummary (+21 more)
...
Cohesion: 0.13
Nodes (9): OeeMasterDataRepository, Every write to the OEE master data.      Idempotent by natural key throughout, Upsert the pattern, then replace its slots wholesale.          Replace rather, Insert an exception, skipping an identical one.          Keyed on the whole wi, Row counts, for the importer's closing log line., None path means every Asset, which is stored as a NULL asset_id., _require_non_empty(), _require_one_of() (+1 more)
...
Cohesion: 0.06
Nodes (26): process_info: should be a dict[str,list[str]] if the list contains the string un, test_main_multiple_scenarios(), *******************************************************************************, Test if the provided configurations for the MQTT server are valid and     there, Test if the mqtt configurations are valid, test_connectivity_to_mqtt(), test_mqtt_config(), ******************************************************************************* (+18 more)
...
- **Why does `Database` connect `Community 125` to `Community 3`, `Community 132`, `Community 4`, `Community 134`, `Community 135`, `Community 8`, `Community 7`, `Community 10`, `Community 5`, `Community 21`, `Community 22`, `Community 153`, `Community 27`, `Community 28`, `Community 29`, `Community 35`, `Community 37`, `Community 38`, `Community 42`, `Community 172`, `Community 45`, `Community 47`, `Community 48`, `Community 185`, `Community 59`, `Community 60`, `Community 64`, `Community 67`, `Community 70`, `Community 75`, `Community 80`, `Community 81`, `Community 82`, `Community 95`, `Community 97`, `Community 98`, `Community 111`, `Community 123`?**
  _High betweenness centrality (0.227) - this node is a cross-community bridge._
- **Why does `UnsMQTTClient` connect `Community 38` to `Community 132`, `Community 39`, `Community 106`, `Community 74`, `Community 176`, `Community 53`, `Community 86`, `Community 123`, `Community 28`, `Community 94`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `YAML` connect `Community 26` to `Community 96`, `Community 101`, `Community 134`, `Community 169`, `Community 137`, `Community 9`, `Community 83`, `Community 52`, `Community 115`, `Community 55`, `Community 152`, `Community 28`?**
